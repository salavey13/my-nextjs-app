gimport { useState, useEffect, useRef, useCallback } from "react"
...
export default function LandingPage() {
  ...
  const handlePlayGame = useCallback(async () => {
    const gameLink = "https://t.me/oneSitePlsBot/vip?ref=salavey13";
              ...
              <Card key={index} className="bg-gray-900 border-gray-800 hover:border-[#e1ff01] transition-colors">
                ...
                <CardContent>
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-block bg-[#e1ff01] text-gray-900 px-4 py-2 rounded hover:bg-opacity-90 transition-colors"
                  >
                    Hire on Contra
                  </a>
                </CardContent>
